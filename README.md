...
CCCSweatGrind is a practice repository for Canadian Computing Competition preparation. It organizes CCC senior problems by year and provides a place for solutions, notes, scripts, and contest practice.
...
```text
2012/ - 2023/   CCC senior problem notes and solutions by year
Lecture/         Practice notebooks and lecture exercises
Script/          Helper scripts for practice workflows
README.md        Contest map and project overview
```

## Usage

Open a year folder, choose a problem, and compare the note file with any available solution scripts. For Python solutions, run them directly:
...
The goal is to build a long-term archive of contest practice with clean problem organization, reusable solution patterns, and quick access to previous CCC senior problems.
